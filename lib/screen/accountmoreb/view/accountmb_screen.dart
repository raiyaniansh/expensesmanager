...
class AccountMBScreen extends StatefulWidget {
  const AccountMBScreen({Key? key}) : super(key: key);

  @override
  State<AccountMBScreen> createState() => _AccountMBScreenState();
}

class _AccountMBScreenState extends State<AccountMBScreen> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        "${homeController.bankin.value -
                            homeController.bankex.value}",
                        style: TextStyle(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) =>(homeController.transactionList[index]['pytype']=="Bank")? InkWell(
                          onTap: () {

          ...
          child: Container(
            child: Column(
              ...
              children: [
                ...
                Align(alignment: Alignment(-1, 0),child: Text("Expense",style: TextStyle(color: Colors.white,fontSize: 20.sp),)),
                SizedBox(
                  height: 1.h,
                ),
                Align(alignment: Alignment(-1, 0),child: Text("${homeController.bankex.value+homeController.cashex.value}.00 INR",style: TextStyle(color: Colors.white,fontSize: 30.sp,fontWeight: FontWeight.bold),)),
                SizedBox(
                  height: 10.h,
                ),
                Stack(
                  children: [
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Obx(
                            ...
                            value: homeController.cashpr.value,
                            strokeWidth: 70.sp,
                          ),
                        ),
                      ),
                    ...
                    Container(
                        ...
                        child: Icon(Icons.upload,color: Colors.white70,size: 50.sp,)
                    ),
                  ],
                ),
                SizedBox(
                ...
                Row(
                  ...
                  children: [
                    Container(height: 2.h,width: 2.h,color: Color(0xff6A4DDF),),
                    SizedBox(width: 2.w,),
                    Text("Bank Expense",style: TextStyle(color: Color(0xff6A4DDF),fontSize: 15.sp),)
                  ],
                ),
                SizedBox(height: 1.h,),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 2.w,),
                    Text("Cash Expense",style: TextStyle(color: Colors.white54,fontSize: 15.sp),)
                  ],
                ),
                SizedBox(
                  height: 2.h,
                ...
                Expanded(
                  child: Obx(() => ListView.builder(
                      ...
                      itemBuilder: (context, index) => (homeController.transactionList[index]['type']=="Expense"||homeController.transactionList[index]['category']=="Expense")?Container(
